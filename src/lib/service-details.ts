...
const details: Record<ServiceSlug, Record<Locale, ServiceDetail>> = {
  "web-apps": {
    ar: {
      ...
      lead: "نطور منصات ويب متكاملة تساعدك تدير العمليات، تتابع العملاء، وتوسع مشروعك بسرعة. التركيز يكون على الأداء، الأمان، وسهولة الاستخدام.",
      steps: [
  ...
  "mobile-apps": {
    ar: {
      ...
      steps: [
        ...
        { head: "3) تطوير وربط الخدمات", text: "نطور التطبيق ونربطه بالخادم، الإشعارات، الدفع، وتسجيل الدخول مع مراعاة الأمان والاستقرار." },
  ...
  "desktop-apps": {
    ar: {
      ...
      flowLabel: "مراحل الخدمة",
      lead: "نطور أنظمة Desktop قوية لإدارة العمليات الداخلية، مناسبة للأعمال التي تحتاج سرعة، استقرار، وتحكم كامل بالبيانات.",
      steps: [
  ...
  "visual-identity": {
    ar: {
      ...
      flowLabel: "مراحل الخدمة",
      lead: "نبني هوية بصرية متكاملة تعكس شخصية مشروعك وتوحد حضوره على كل نقاط التواصل الرقمية والمطبوعة.",
      steps: [
  ...
  "social-media": {
    ar: {
      ...
      flowLabel: "مراحل الخدمة",
      lead: "نحول حساباتك من وجود عادي إلى قناة نمو حقيقية عبر خطة محتوى، إدارة احترافية، وحملات ممولة دقيقة.",
      steps: [
  ...
  "office-services": {
    ar: {
      title: "خدمات مكتبية",
      flowLabel: "مراحل الخدمة",
      lead: "نطور أدوات داخلية ذكية لتقليل العمل اليدوي، تنظيم العمليات، ورفع كفاءة فرق العمل يوما بعد يوم.",
      steps: [
