    ...
    vision: {
      ...
      cards: [
        ...
        },
        {
          ...
          body:
            "نوفر لك مختلف الحلول الرقمية تحت سقف واحد، مما يوفر الوقت والجهد ويجنبك تعقيدات التعامل مع عدة أطراف، نعمل على فهم رؤيتك بشكل كامل لنقدم لك حلولًا متناسقة تخدم أهدافك.",
        },
        {
          title: "عمل متكامل",
          body:
            "يتم تنسيق جميع جوانب المشروع بشكل منظم لضمان انسجام العمل من البداية حتى النهاية، مما ينعكس على جودة المنتج النهائي وسرعة التنفيذ، نحن لا نقدم خدمات منفصلة، بل حلولًا مترابطة تخدم هدفك بالكامل.",
        },
      ],
    },
    packages: {
      ...
      items: [
        {
          ...
          price: "بداية",
          description: "الخطوة الأولى لتمثيل مشروعك رقمياً",
          features: [
