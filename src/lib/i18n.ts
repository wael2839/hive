...
const messages: Record<Locale, Messages> = {
  ...
  ar: {
    meta: {
      title: "هايف لحلول الرقمية | وكالة رقمية راقية",
      description:
        "هايف لحلول الرقمية تصمم وتنفّذ تجارب رقمية غامرة واستراتيجية منتجات وهندسة على مستوى المؤسسات.",
    },
    nav: {
      brand: "Hive",
      home: "الرئيسية",
    ...
    hero: {
      ...
      secondary: "نهجنا",
      imageAlt: "هايف — صورة تعريفية للاستوديو الرقمي",
    },
    about: {
      kicker: "من نحن",
      ...
      body:
        "هايف استوديو متعدد التخصصات يضم استراتيجيين ومصممين ومهندسين. نجمع السرد العلامي مع تفكير الأنظمة—لنقدّم منصات تبدو حتمية، قابلة للتوسّع، وفاخرة بلا جدال.",
    ...
    footer: {
      rights: "© هايف لحلول الرقمية. جميع الحقوق محفوظة.",
