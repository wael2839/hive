          ...
          <div className="mx-auto mt-10 max-w-5xl">
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-10 lg:gap-20">
              {featureLabels.map((label, idx) => {
                ...
                return (
                  ...
                  >
                    <span className=" inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-hive-btn-to to-hive-btn-from text-neutral-900">
            ...
            >
              <div className="px-6 py-8 text-center md:border-e md:border-hive-border">
                <span className="mx-auto mb-3 inline-flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-hive-btn-to to-hive-btn-from text-neutral-900">
