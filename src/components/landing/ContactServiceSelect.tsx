...
const triggerClass =
  "flex h-[44px] w-full items-center justify-between gap-3 rounded-md border border-hive-border bg-[var(--hive-bg)] px-3.5 py-2 text-start text-sm outline-none transition focus:border-hive-gold-light focus:outline-none light:bg-white light:text-neutral-900";
